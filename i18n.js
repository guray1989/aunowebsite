...
const translations = {
  en: {
    ...
    'sector-confectionery': 'Confectionery & Chocolate',
    'sector-snacks': 'Snacks',
    'sector-meat-dairy': 'Meat & Dairy',
    'sector-ready-meals': 'Ready Meals & Meal Kits',
    'sector-premium': 'Premium Products',
    'sector-fresh-produce': 'Fresh Produce',
  ...
  tr: {
    ...
    'sector-confectionery': 'Şekerleme & Çikolata',
    'sector-snacks': 'Atıştırmalık Ürünler',
    'sector-meat-dairy': 'Et & Süt Ürünleri',
    'sector-ready-meals': 'Hazır Yemek & Meal Kit',
    'sector-premium': 'Premium / Lüks Ürünler',
    'sector-fresh-produce': 'Meyve & Sebze',
...
function setLanguage(lang) {
  ...
  elements.forEach(element => {
    ...
    if (translations[lang] && translations[lang][key]) {
      // Check if translation contains HTML tags (span, br, etc.)
      const translation = translations[lang][key];
      const containsHTML = /<[^>]+>/.test(translation);
      
      // Use innerHTML if HTML tags are present, otherwise use textContent
      if (containsHTML) {

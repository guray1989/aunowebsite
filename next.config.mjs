  ...
  async rewrites() {
    return {
      beforeFiles: [
        ...
        { source: '/:lang(tr|en)/solutions/', destination: '/solutions/index.html' },
        { source: '/:lang(tr|en)/solutions/index.html', destination: '/solutions/index.html' },
        { source: '/solutions/shelf-life', destination: '/solutions/index.html' },
        { source: '/solutions/shelf-performance', destination: '/solutions/index.html' },
        { source: '/solutions/small-batches', destination: '/solutions/index.html' },
        { source: '/solutions/data-guided', destination: '/solutions/index.html' },
